//
//  NoteTableCellViewModelTests.swift
//  TawkCodingTestTests
//
...
final class NoteTableCellViewModelTests: XCTestCase {
    ...
    func testNoteTableCellViewModel() throws {
        ...
        var viewModel = NoteTableCellViewModel(userDataModel: dataModel, imageProvider: imageProvider)
    ...
    func testNoteTableCellViewModel_ForWrongDataModel() throws {
